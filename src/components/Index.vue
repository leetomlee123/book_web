...
export default {
    ...
    methods: {
        ...
        async fetchCateBooks() {
            ...
            var res = await http.get("/book/category/" + this.cate + "/" + this.page + "/" + this.size);
            this.books = res.data
        ...
        async onSearch() {
            ...
            var res = await http.get("/book/search", {
                params: {
                    "key": this.value,
                    "page": this.page,
                    "size": this.size
            ...
            this.books = res.data == null ? [] : res.data
