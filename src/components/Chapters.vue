...
export default {
    ...
    methods: {
        async fetchBookInfo() {
            ...
            var response = await http.get("/book/detail/" + this.$store.state.bid);
        ...
        async joinShelf() {
            this.loding = true
            var action = this.inS ? "del" : "add"
            var response = await http.get("/book/action/" + this.$store.state.bid + "/" + action);
        ...
        inShelf() {
            var inB = false;
            var shelf = this.$store.state.shelf
